...
import { SubmitBtn, ErrorFallback } from '..';
const Actions = ({ setDucks }) => {
	...
	// 	e.preventDefault();
	// 	try {
	// 		const validationErrors = validateMyDuckForm(form);
	// 		// console.log(validationErrors);
	...
	return (
		<section className='justify-self-end flex flex-col items-center gap-4 border-2 rounded-lg p-4 mx-8'>
			...
			<ErrorBoundary FallbackComponent={ErrorFallback}>
				<form action={submitAction} className='flex flex-col gap-4 w-3/4'>
